...
- [x] 8. User approved 2026-07-10 after real-corpus E2E through the UI (30 files via file picker -> review -> apply -> optimize, $15,891/yr detected, oversize combined PDF rejected cleanly, no statement content server-side). Merged to main, prod verified, tagged v1.2.0.
